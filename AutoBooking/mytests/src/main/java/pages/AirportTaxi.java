...
public class AirportTaxi extends StartPage {
	...
	public AirportTaxi(WebDriver webdriver) {
		super(webdriver);
	...
	public boolean resutsApear() throws Exception {
		return (new WebDriverWait(webdriver, 10))
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[text()='Book taxi'])[1]")))
				.isDisplayed();
	}
